(() => {
    ...
    function s(e, s, i) {
        return (
            (s = t(s)) in e
                ? Object.defineProperty(e, s, { value: i, enumerable: !0, configurable: !0, writable: !0 })
                : (e[s] = i),
            e
        );
    }
        ...
        parent: function (e) {
            ...
            for (let s = 0; s < this.length; s += 1)
                null !== this[s].parentNode &&
                    (e ? u(this[s].parentNode).is(e) && t.push(this[s].parentNode) : t.push(this[s].parentNode));
            return u(t);
        },
        parents: function (e) {
            const t = [];
            ...
            if (((c = i && e > o ? o : i && e < d ? d : e), a.updateProgress(c), r.cssMode)) {
                ...
                if (0 === t) l[e ? "scrollLeft" : "scrollTop"] = -c;
                    ...
                    if (!a.support.smoothScroll)
                        return S({ swiper: a, targetPosition: -c, side: e ? "left" : "top" }), !0;
        ...
        slideTo: function (e = 0, t = this.params.speed, s = !0, i, n) {
            ...
            if (l.cssMode) {
                ...
                if (0 === t) {
                    ...
                    if (!a.support.smoothScroll)
                        return S({ swiper: a, targetPosition: s, side: e ? "left" : "top" }), !0;
    ...
    function G(e) {
        ...
        if (
            ...
            let e = !0;
            p.is(n.focusableElements) && ((e = !1), "SELECT" === p[0].nodeName && (n.isTouched = !1)),
                s.activeElement &&
    ...
    function B(e) {
        ...
        if (!s.allowTouchMove)
            return (
                ...
                void (
                    i.isTouched &&
                    (Object.assign(a, { startX: p, startY: u, currentX: p, currentY: u }), (i.touchStartTime = b()))
                )
            );
        ...
        if (
            ...
            m > 0 && i.currentTranslate > s.minTranslate()
                ? ((v = !1),
                  n.resistance &&
                      (i.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + i.startTranslate + m) ** w))
                : m < 0 &&
                  i.currentTranslate < s.maxTranslate() &&
                  ((v = !1),
                  n.resistance &&
                      (i.currentTranslate = s.maxTranslate() + 1 - (s.maxTranslate() - i.startTranslate - m) ** w)),
    ...
    function N(e) {
        ...
        if (c > i.longSwipesMs) {
            ...
            "next" === t.swipeDirection &&
                (g >= i.longSwipesRatio ? t.slideTo(i.rewind && t.isEnd ? f : u + w) : t.slideTo(u)),
    ...
    const q = (e, t) => {
        ...
        if (d.touch) {
            ...
            a[p](n.start, e.onTouchStart, t),
                a[p](n.move, e.onTouchMove, d.passiveListener ? { passive: !1, capture: c } : c),
        ...
        (i.preventClicks || i.preventClicksPropagation) && a[p]("click", e.onClick, !0),
            ...
            i.updateOnWindowResize
                ? e[u](o.ios || o.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", _, !0)
            ...
            transition: {
                ...
                transitionEnd: function (e = !0, t) {
                    const s = this,
                        { params: i } = s;
                    (s.animating = !1),
                        i.cssMode || (s.setTransition(0), A({ swiper: s, runCallbacks: e, direction: t, step: "End" }));
                },
            },
            slide: z,
            loop: D,
            ...
            e.params.createElements &&
                Object.keys(i).forEach((a) => {
                    if (!s[a] && !0 === s.auto) {
                        ...
                        r || ((r = n.createElement("div")), (r.className = i[a]), e.$el.append(r)),
                            (s[a] = r),
                            (t[a] = r);
                    }
                }),
    ...
    ee.use([
        ...
        function ({ swiper: e, extendParams: t, on: s, emit: i }) {
            ...
            function c() {
                ...
                "hidden" === t.visibilityState && e.autoplay.running && d(),
                    "visible" === t.visibilityState && e.autoplay.paused && (a(), (e.autoplay.paused = !1));
            }
            function p(t) {
                e &&
                    !e.destroyed &&
                ...
                (function (e) {
                    ...
                    setTranslate: () => {
                        ...
                        for (let i = 0; i < t.length; i += 1) {
                            ...
                            ie(s, t).css({ opacity: r }).transform(`translate3d(${n}px, ${a}px, 0px)`);
                        }
                    },
                    setTransition: (t) => {
        ...
        function ({ swiper: e, extendParams: t, on: s }) {
            ...
            function a() {
                ...
                let n;
                if (
                    ((n = t.params.loop ? parseInt(g(t.clickedSlide).attr("data-swiper-slide-index"), 10) : s),
                    e.params.loop)
                ) {
                    let t = e.activeIndex;
            ...
            function r() {
                ...
                return (
                    e.thumbs.swiper.$el.addClass(e.params.thumbs.thumbsContainerClass), e.thumbs.swiper.on("tap", a), !0
                );
            }
            function l(t) {
                ...
                if (
                    ...
                    for (let t = 0; t < n; t += 1)
                        s.$wrapperEl.children(`[data-swiper-slide-index="${e.realIndex + t}"]`).addClass(a);
                else for (let t = 0; t < n; t += 1) s.slides.eq(e.realIndex + t).addClass(a);
        ...
        document.addEventListener("DOMContentLoaded", function () {
            re(".feedback_slider", ".feedback_slider-pagination", {
                slidesPerView: 1,
                spaceBetween: 30,
                breakpoints: { 767.98: { slidesPerView: 2 }, 1023.98: { slidesPerView: 1 } },
            });
        });
})();
