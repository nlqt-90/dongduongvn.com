(() => {
    ...
    var r = function e(t, r) {
        ...
        if (t && r && "object" == typeof t && "object" == typeof r) {
            ...
            for (s = i; 0 != s--; ) if (!Object.prototype.hasOwnProperty.call(r, o[s])) return !1;
            for (s = i; 0 != s--; ) {
                var l = o[s];
        ...
        constructor({
            ...
            if (
                ...
                if (!r(this.options, o.instance.options))
                    throw new Error(
                        `Loader must not be called again with different options. ${JSON.stringify(this.options)} !== ${JSON.stringify(o.instance.options)}`
                    );
                return o.instance;
            }
            o.instance = this;
    ...
    var l = [
        ...
        n = "AIzaSyA9Ku_njl75VNv-ARVb0I7-0vt2a43ZZbk";
    document.addEventListener("DOMContentLoaded", function () {
        var e, r, i, s;
        (e = "#map"),
            (r = new o({ apiKey: n, version: "weekly" })),
            (i = document.querySelector(e)),
            (s = { lat: 10.7523442, lng: 106.6637139 }),
            i &&
                r.load().then(function () {
                    var e = {
                        ...
                        r = new google.maps.Map(i, {
                            center: { lat: 10.7523442, lng: 106.6637139 },
                            zoom: 17,
                            styles: t(l),
                            disableDefaultUI: !0,
                        });
