                                            ...
                                            function (t, e, n) {
                                                ...
                                                (function (t) {
                                                    ...
                                                    var l = "undefined" != typeof window ? window : t,
                                                        ...
                                                        _ = function (t) {
                                                            if (t === f)
                                                                (f = t._next) ? (f._previous = null) : (p = null);
                                                            else if (t === p)
                                                                (p = t._previous) ? (p._next = null) : (f = null);
                                                            else {
                                                                var e = t._previous,
                                                                    n = t._next;
                        ...
                        5: [
                            function (t, e, n) {
                                var r = t("shifty"),
                                    i = t("./utils"),
                                    o = r.Tweenable,
                                    a = { easeIn: "easeInCubic", easeOut: "easeOutCubic", easeInOut: "easeInOutCubic" },
                                    s = function t(e, n) {
                                ...
                                (this.count = function (t) {
                                    ...
                                    (i.remaining = i.duration - e),
                                        i.useEasing
                                            ? i.countDown
                                                ? (i.frameVal =
                                                      i.startVal - i.easingFn(e, 0, i.startVal - i.endVal, i.duration))
                                            ...
                                            : (i.frameVal = i.startVal + (i.endVal - i.startVal) * (e / i.duration));
                                ...
                                (this.formatNumber = function (t) {
                                    ...
                                    if (
                                        ...
                                        for (var u = 3, l = 0, c = 0, h = n.length; c < h; ++c)
                                            i.options.useIndianSeparators && 4 === c && ((u = 2), (l = 1)),
                        ...
                        e.forEach(function (t) {
                            ...
                            new IntersectionObserver(function (t, e) {
                                t.forEach(function (t) {
                                    t.intersectionRatio > 0 && (s.animate(a, { duration: 500 }), e.unobserve(t.target));
                                });
                            }).observe(t);
                        });
                })();
