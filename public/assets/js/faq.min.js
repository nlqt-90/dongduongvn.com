(() => {
    ...
    function F(t) {
        for (var e = x(t), i = z(t); i && W(i) && "static" === R(i).position; ) i = z(i);
        return i && ("html" === C(i) || ("body" === C(i) && "static" === R(i).position))
            ? e
            : i ||
                  (function (t) {
                      var e = -1 !== navigator.userAgent.toLowerCase().indexOf("firefox");
                      if (-1 !== navigator.userAgent.indexOf("Trident") && k(t) && "fixed" === R(t).position)
                          return null;
                      var i = q(t);
                      for (S(i) && (i = i.host); k(i) && ["html", "body"].indexOf(C(i)) < 0; ) {
                          var n = R(i);
                          if (
                              "none" !== n.transform ||
                              "none" !== n.perspective ||
        ...
        fn: function (t) {
            ...
            if (h && d) {
                var m = (function (t, e) {
                    ...
                    x = V(O, C, T),
                    L = f;
                r.modifiersData[l] = (((e = {})[L] = x), (e.centerOffset = x - C), e);
            }
        },
        effect: function (t) {
            var e = t.state,
    ...
    function Z(t) {
        ...
        if (p) {
            ...
            if (
                (L === x(r) &&
                    "static" !== R((L = $(r))).position &&
                    "absolute" === u &&
                    ((k = "scrollHeight"), (S = "scrollWidth")),
                l === i || ((l === o || l === s) && h === c))
            )
                (T = n),
                    (y -= (g && L === C && C.visualViewport ? C.visualViewport.height : L[k]) - a.height),
                    (y *= f ? 1 : -1);
            if (l === o || ((l === i || l === n) && h === c))
                (O = s),
                    (b -= (g && L === C && C.visualViewport ? C.visualViewport.width : L[S]) - a.width),
                    (b *= f ? 1 : -1);
        }
        var D,
            N = Object.assign({ position: u }, p && G),
            I =
                !0 === m
                    ? (function (t) {
                          var e = t.x,
        ...
        return (
            ...
            f
                ...
                : Object.assign(
                      {},
                      N,
                      (((e = {})[T] = A ? y + "px" : ""), (e[O] = E ? b + "px" : ""), (e.transform = ""), e)
                  )
        );
    }
    const J = {
    ...
    function ct(t) {
        return ["html", "body", "#document"].indexOf(C(t)) >= 0 ? t.ownerDocument.body : k(t) && lt(t) ? t : ct(q(t));
    }
    function ht(t, e) {
        var i;
        void 0 === e && (e = []);
    ...
    function ft(t, e, i) {
        var n =
                "clippingParents" === e
                    ? (function (t) {
                          var e = ht(q(t)),
                              i = ["absolute", "fixed"].indexOf(R(t).position) >= 0 && k(t) ? F(t) : t;
                          return L(i)
                              ? e.filter(function (t) {
                                    return L(t) && B(t, i) && "body" !== C(t);
                                })
                              : [];
                      })(t)
                    : [].concat(e),
    ...
    function mt(t, e) {
        ...
        var o = e,
            ...
            T = t.rects.popper,
            C = t.elements[y ? O : b],
            x = ft(L(C) ? C : C.contextElement || $(t.elements.popper), p, g),
            k = M(t.elements.reference),
            S = pt({ reference: k, element: T, strategy: "absolute", placement: l }),
            D = dt(Object.assign({}, T, S)),
            N = b === u ? D : k,
            I = {
            ...
            if (!e.modifiersData[h]._skip) {
                for (
                    var d = c.mainAxis,
                        ...
                        L = [T].concat(x).reduce(function (t, i) {
                            return t.concat(
                                N(i) === r
                                    ? (function (t, e) {
                                          void 0 === e && (e = {});
    ...
    const yt = {
        ...
        fn: function (t) {
            var e = t.state,
                ...
                u = h.y;
            null != e.modifiersData.popperOffsets &&
                ((e.modifiersData.popperOffsets.x += d), (e.modifiersData.popperOffsets.y += u)),
                (e.modifiersData[r] = c);
        },
    };
    const wt = {
            ...
            if (x) {
                if (h) {
                    var B,
                        ...
                        it = tt[W],
                        nt = V(0, L[$], J[$]),
                        st = O ? L[$] / 2 - X - nt - et - D.mainAxis : Y - nt - et - D.mainAxis,
                        ot = O ? -L[$] / 2 + X + nt + it + D.mainAxis : G + nt + it + D.mainAxis,
                        rt = e.elements.arrow && F(e.elements.arrow),
                        at = rt ? ("y" === T ? rt.clientTop || 0 : rt.clientLeft || 0) : 0,
                        lt = null != (B = null == j ? void 0 : j[T]) ? B : 0,
                        ct = q + ot - lt,
                        ht = V(b ? P(z, q + st - lt - at) : z, q, b ? I(K, ct) : K);
                    (x[T] = ht), (M[T] = ht - q);
                }
                if (u) {
                    var dt,
                        ...
                        bt = pt - w[ft],
                        vt = -1 !== [i, o].indexOf(E),
                        yt = null != (dt = null == j ? void 0 : j[C]) ? dt : 0,
                        wt = vt ? _t : pt - L[gt] - k[gt] - yt + D.altAxis,
                        Et = vt ? pt + L[gt] + k[gt] - yt - D.altAxis : bt,
                        At =
                            b && vt
                                ? (function (t, e, i) {
                                      var n = V(t, e, i);
    ...
    function At(t, e, i) {
        ...
        return (
            (o || (!o && !i)) &&
                (("body" !== C(e) || lt(a)) &&
                    (c = (n = e) !== x(n) && k(n) ? { scrollLeft: (s = n).scrollLeft, scrollTop: s.scrollTop } : rt(n)),
                k(e) ? (((h = M(e, !0)).x += e.clientLeft), (h.y += e.clientTop)) : a && (h.x = at(a))),
                ...
                h = {
                    ...
                    setOptions: function (i) {
                        ...
                        d(),
                            ...
                            (a.scrollParents = {
                                reference: L(t) ? ht(t) : t.contextElement ? ht(t.contextElement) : [],
                                popper: ht(e),
                            });
                        var r = (function (t) {
                            var e = Ot(t);
    ...
    var Lt = xt(),
        kt = xt({ defaultModifiers: [et, wt, J, D, yt, gt, Et, Y, vt] }),
                      ...
                      return function n(s) {
                          ...
                          for (let { target: r } = s; r && r !== this; r = r.parentNode)
                              for (let a = o.length; a--; )
                                  if (o[a] === r)
                                      return (
                                          (s.delegateTarget = r), n.oneOff && ue.off(t, s.type, e, i), i.apply(r, [s])
                                      );
                          return null;
                      };
                  })(t, i, n)
    ...
    class je extends me {
        ...
        _getConfig(t) {
            return (
                (t = { ...Te, ...Ee.getDataAttributes(this._element), ...("object" == typeof t ? t : {}) }),
                Bt(Oe, t, Ce),
                t
            );
        }
        ...
        _triggerSlideEvent(t, e) {
            ...
            return ue.trigger(this._element, "slide.bs.carousel", { relatedTarget: t, direction: e, from: n, to: i });
        }
        ...
        _slide(t, e) {
            ...
            const u = () => {
                ue.trigger(this._element, Ne, { relatedTarget: o, direction: d, from: s, to: r });
            };
            ...
            } else n.classList.remove(Ie), o.classList.add(Ie), (this._isSliding = !1), u();
            a && this.cycle();
        }
        _directionToOrder(t) {
            return [Se, ke].includes(t) ? (Vt() ? (t === ke ? Le : xe) : t === ke ? xe : Le) : t;
        }
        _orderToDirection(t) {
            return [xe, Le].includes(t) ? (Vt() ? (t === Le ? ke : Se) : t === Le ? Se : ke) : t;
        }
    ...
    ue.on(document, "click.bs.carousel.data-api", "[data-bs-slide], [data-bs-slide-to]", je.dataApiClickHandler),
    ...
    ue.on(document, "click.bs.collapse.data-api", Ue, function (t) {
    ...
    class ui extends me {
        ...
        show() {
            ...
            this._inNavbar ? Ee.setDataAttribute(this._menu, "popper", "none") : this._createPopper(e),
                "ontouchstart" in document.documentElement &&
                    ...
                    [].concat(...document.body.children).forEach((t) => ue.on(t, "mouseover", qt)),
                this._element.focus(),
        ...
        _completeHide(t) {
            ue.trigger(this._element, "hide.bs.dropdown", t).defaultPrevented ||
                ("ontouchstart" in document.documentElement &&
                    [].concat(...document.body.children).forEach((t) => ue.off(t, "mouseover", qt)),
        ...
        _createPopper(t) {
            ...
            (this._popper = kt(i, this._menu, n)), s && Ee.setDataAttribute(this._menu, "popper", "static");
        }
        _isShown(t = this._element) {
    ...
    ue.on(document, ti, ii, ui.dataApiKeydownHandler),
        ue.on(document, ti, ni, ui.dataApiKeydownHandler),
        ue.on(document, Je, ui.clearMenus),
        ue.on(document, "keyup.bs.dropdown.data-api", ui.clearMenus),
        ue.on(document, Je, ii, function (t) {
    ...
    class wi {
        ...
        _append() {
            this._isAppended ||
                ...
                ue.on(this._getElement(), yi, () => {
                    Xt(this._config.clickCallback);
                }),
                (this._isAppended = !0));
        }
        dispose() {
            this._isAppended && (ue.off(this._element, yi), this._element.remove(), (this._isAppended = !1));
        }
        _emulateAnimation(t) {
    ...
    class Ci {
        ...
        deactivate() {
            this._isActive && ((this._isActive = !1), ue.off(document, Oi));
        }
        _handleFocusin(t) {
            const { target: e } = t,
    ...
    class $i extends me {
        ...
        show(t) {
            ...
            ue.trigger(this._element, Ii, { relatedTarget: t }).defaultPrevented ||
                ((this._isShown = !0),
        ...
        hide() {
            ...
            t && (this._isTransitioning = !0),
                ...
                ue.off(this._element, ji),
                ue.off(this._dialog, Hi),
                this._queueCallback(() => this._hideModal(), this._element, t);
        }
        dispose() {
            [window, this._dialog].forEach((t) => ue.off(t, Li)),
        ...
        _setEscapeEvent() {
            this._isShown
                ? ue.on(this._element, Mi, (t) => {
                      this._config.keyboard && t.key === ki
                          ? (t.preventDefault(), this.hide())
                          : this._config.keyboard || t.key !== ki || this._triggerBackdropTransition();
                  })
                : ue.off(this._element, Mi);
        }
        _setResizeEvent() {
            this._isShown ? ue.on(window, Pi, () => this._adjustDialog()) : ue.off(window, Pi);
        }
        _hideModal() {
            (this._element.style.display = "none"),
                ...
                this._backdrop.hide(() => {
                    document.body.classList.remove(Bi),
                        ...
                        ue.trigger(this._element, Ni);
                });
        }
        _showBackdrop(t) {
            ue.on(this._element, ji, (t) => {
    ...
    class Xi extends me {
        ...
        _getConfig(t) {
            return (
                (t = { ...zi, ...Ee.getDataAttributes(this._element), ...("object" == typeof t ? t : {}) }),
                Bt(qi, t, Fi),
                t
            );
        }
    ...
    ue.on(document, "click.bs.offcanvas.data-api", '[data-bs-toggle="offcanvas"]', function (t) {
        ...
        ue.on(window, "load.bs.offcanvas.data-api", () => Ae.find(Vi).forEach((t) => Xi.getOrCreateInstance(t).show())),
        ge(Xi),
        Kt(Xi);
    ...
    class _n extends me {
        ...
        dispose() {
            clearTimeout(this._timeout),
                ue.off(this._element.closest(fn), pn, this._hideModalHandler),
        ...
        show() {
            ...
            pe.set(n, this.constructor.DATA_KEY, this),
                ...
                this._popper ? this._popper.update() : (this._popper = kt(this._element, n, this._getPopperConfig(r))),
                n.classList.add(cn);
        ...
        _setListeners() {
            this._config.trigger.split(" ").forEach((t) => {
                if ("click" === t)
                    ue.on(this._element, this.constructor.Event.CLICK, this._config.selector, (t) => this.toggle(t));
                else if ("manual" !== t) {
                ...
                ue.on(this._element.closest(fn), pn, this._hideModalHandler),
    ...
    const En = "scrollspy",
        ...
        xn = "active",
        Ln = ".nav-link",
        kn = ".nav-link, .list-group-item, .dropdown-item",
        Sn = "position";
    class Dn extends me {
        constructor(t, e) {
            super(t),
        ...
        refresh() {
            ...
            Ae.find(kn, this._config.target)
                .map((t) => {
                    const n = It(t),
        ...
        dispose() {
            ue.off(this._scrollElement, An), super.dispose();
        }
        _getConfig(t) {
            return (
                ((t = {
        ...
        _activate(t) {
            ...
            const e = kn.split(",").map((e) => `${e}[data-bs-target="${t}"],${e}[href="${t}"]`),
                    ...
                    : Ae.parents(i, ".nav, .list-group").forEach((t) => {
                          Ae.prev(t, ".nav-link, .list-group-item").forEach((t) => t.classList.add(xn)),
                              Ae.prev(t, ".nav-item").forEach((t) => {
                                  Ae.children(t, Ln).forEach((t) => t.classList.add(xn));
                              });
                      }),
    ...
    class Fn extends me {
        ...
        _getConfig(t) {
            return (
                (t = { ...zn, ...Ee.getDataAttributes(this._element), ...("object" == typeof t && t ? t : {}) }),
    ...
    const Un = function () {
        var t = document.querySelectorAll(".accordion-trigger"),
            ...
            i = document.querySelectorAll(".accordion-trigger_icon");
                ...
                t.preventDefault(),
                    ...
                    e.forEach(function (t, e) {
                        t.classList.contains("expanded")
                            ? (i[e].classList.remove("icon-plus"), i[e].classList.add("icon-minus"))
                            : (i[e].classList.add("icon-plus"), i[e].classList.remove("icon-minus"));
                    });
            });
        });
    };
